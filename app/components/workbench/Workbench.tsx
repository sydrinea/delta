...
import { toDot, toDotTM } from "@/lib/compiler/dot";
...
import { simulate as simulateNFAWithTrace } from "@/lib/simulator/nfa";
import { simulate as simulateTMWithTrace } from "@/lib/simulator/tm";
  ...
  const traceConfig = {
    nfa: {
      ...
      simulate: (machine: TraceMachine, input: string) =>
        simulateNFAWithTrace(machine as NFA, input),
    ...
    tm: {
      ...
      tests: tm.tests,
      simulate: (machine: TraceMachine, input: string) =>
        simulateTMWithTrace(machine as TuringMachine, input),
      getDot: (machine: TraceMachine, states: Set<string>) =>
