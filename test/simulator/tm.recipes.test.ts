...
import tm, { multitape, type TuringMachine } from "@/lib/compiler/tm";
...
const EXAMPLES_DIR = join(__dirname, "../../public/examples/tm");
...
function tape3Result(result: ReturnType<typeof simulate>): string {
...
describe("TM example recipes", () => {
  ...
  describe("binary-addition tape output", () => {
    ...
    it.each([
      ...
      (input, expectedSum, _label) => {
        const result = simulate(machine, input);
